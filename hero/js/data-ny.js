...
const HERO_NY = {
  ...
  lugares: [
    /* --- Midtown --- */
    { n: 'Plaza Food Hall', z: 'Midtown', tipo: 'restaurante', conf: 'fechado',
      d: 'Fechado em definitivo desde a pandemia.',
      f: [{ t: 'Yelp', u: 'https://www.yelp.com/biz/the-plaza-food-hall-new-york' }] },
    { n: 'LAVO', z: 'Midtown', tipo: 'restaurante', conf: 'fechado',
    ...
    { n: 'Del Frisco’s Double Eagle', z: 'Midtown', tipo: 'restaurante', conf: 'aberto',
    ...
    { n: 'Carmine’s', z: 'Midtown / Broadway', tipo: 'restaurante', conf: 'nao-confirmado',
    ...
    { n: 'PHD Rooftop (Dream Downtown)', z: 'Chelsea', tipo: 'rooftop', conf: 'mudou',
    ...
    { n: 'Chelsea Market', z: 'Chelsea', tipo: 'mercado', conf: 'nao-confirmado',
    ...
    { n: 'Pier 57 / Market 57', z: 'Chelsea (Hudson River Park)', tipo: 'mercado', conf: 'aberto',
    ...
    { n: 'Estiatorio Milos', z: 'Hudson Yards e Midtown', tipo: 'restaurante', conf: 'aberto',
    ...
    { n: 'Mercado Little Spain', z: 'Hudson Yards', tipo: 'mercado', conf: 'nao-confirmado',
      d: 'Não consegui confirmar em fonte primária. Fica no subsolo do Hudson Yards, do José Andrés.', f: [] },

    /* --- SoHo / Downtown --- */
    { n: 'Balthazar', z: 'SoHo', tipo: 'restaurante', conf: 'aberto',
    ...
    { n: 'Pastis', z: 'Meatpacking', tipo: 'restaurante', conf: 'nao-confirmado',
    ...
    { n: 'Eataly', z: 'Flatiron e World Trade Center', tipo: 'mercado', conf: 'nao-confirmado',
    ...
    { n: 'Eileen’s Special Cheesecake', z: 'Nolita', tipo: 'doce', conf: 'aberto',
    ...
    { n: 'Century 21', z: 'Financial District', tipo: 'loja', conf: 'aberto',
    ...
    { n: 'Momofuku Noodle Bar', z: 'East Village e Columbus Circle', tipo: 'restaurante', conf: 'mudou',
    ...
    { n: 'HaSalon', z: 'Hell’s Kitchen', tipo: 'restaurante', conf: 'nao-confirmado',
    ...
    { n: 'The River Cafe', z: 'Brooklyn (Dumbo)', tipo: 'restaurante', conf: 'nao-confirmado',
      d: 'Não confirmado. Vale lembrar sua ressalva: você achou caro e turístico, e a mamãe amou.', f: [] },

    /* --- lojas --- */
    { n: 'Anthropologie', z: 'vários', tipo: 'loja', conf: 'nao-confirmado', d: 'Primeira da sua lista por ordem de necessidade. Rede grande.', f: [] },
    { n: 'Williams Sonoma', z: 'Columbus Circle e outros', tipo: 'loja', conf: 'nao-confirmado', d: 'Uma das suas preferidas; a do mall de Columbus Circle é a que você cita.', f: [] },
    { n: 'Pottery Barn', z: 'vários', tipo: 'loja', conf: 'nao-confirmado', d: '', f: [] },
    { n: 'Urban Outfitters', z: 'vários', tipo: 'loja', conf: 'nao-confirmado', d: '', f: [] },
    { n: 'Crate & Barrel', z: 'vários', tipo: 'loja', conf: 'nao-confirmado', d: '', f: [] },
    { n: 'MacKenzie-Childs', z: 'SoHo', tipo: 'loja', conf: 'mudou',
    ...
    { n: 'The Container Store', z: 'Chelsea (629 Sixth Ave)', tipo: 'loja', conf: 'mudou',
    ...
    { n: 'deVOL Kitchens', z: 'NoHo', tipo: 'loja', conf: 'aberto',
    ...
    { n: 'Banana Republic (pé do Rockefeller)', z: 'Midtown', tipo: 'loja', conf: 'nao-confirmado',
      d: 'A sua "melhor Banana Republic eveeeeer". Não confirmei se a unidade específica segue lá.', f: [] },
    { n: 'Whole Foods Market (Columbus Circle)', z: 'Columbus Circle', tipo: 'mercado', conf: 'nao-confirmado',
